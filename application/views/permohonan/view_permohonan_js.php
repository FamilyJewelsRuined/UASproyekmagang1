<script>        
    ...
    (function initPermohonanScript() {
        if (typeof jQuery === 'undefined' || typeof jQuery.fn.select2 === 'undefined') {
            // Wait 50ms and check again (Select2 should be loaded from header.php)
            setTimeout(initPermohonanScript, 50);
            return;
        }
        
        // Select2 is available, now initialize the permohonan script
        $(function () {
...
// this gives Kurs Transaksi that 0
        $(function() {
 ...
 $('.select2-customer').select2({
    theme: 'bootstrap-5',
            placeholder: 'massukan nama customer',
            allowClear: false,
            width: '100%',
...
$('.select2-muatan').select2({
    theme: 'bootstrap-5',
            placeholder: 'massukan nama Muatan',
            allowClear: false,
            width: '100%',
            minimumInputLength: 3,
            ajax: {
...
///end tongkang
        ...
        // Trigger datepicker saat ikon kalender diklik
        $('#TANGGAL_DRAFT').closest('.input-group').find('.input-group-text').on('click', function() {
            $('#TANGGAL_DRAFT').datepicker('show');
        });
        ...
        // Trigger datepicker saat ikon kalender diklik
        $('#TANGGAL_LEWAT_INPUT').closest('.input-group').find('.input-group-text').on('click', function() {
            $('#TANGGAL_LEWAT_INPUT').datepicker('show');
        });
    ...
    })(); // Close initPermohonanScript wrapper function
</script>
