<head>
    <!-- BOOTSTRAP CSS - Removed Bootstrap 4 CSS as Bootstrap 5 is already loaded in header.php -->

<!-- SELECT2 CSS -->
<link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
<link rel="stylesheet" href="<?php echo base_url('templates/css/bootstrap-datepicker.min.css');?>">
...
<!-- Scripts are already loaded in header.php (jQuery, Bootstrap 5, Select2, Datepicker) -->
