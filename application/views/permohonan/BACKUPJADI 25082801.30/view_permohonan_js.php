<script>
    $(function () {
        ...
        const PPA_FORM_URL = "<?= current_url(); ?>"; 
        function reloadForm() {
    ...
    document.getElementById('JAM_LEWAT_INPUT').addEventListener('input', maskTimeInput);
        ...
        $('#CUSTOMER_ID').on('select2:select', function (e) {
            ...
            var typeMap = { 1: "PRA BAYAR", 2: "PASCA BAYAR" };
    ...
    function simpanPpa() {
        ...
        $.ajax({
            url: "<?php echo base_url('permohonan/simpanPpa'); ?>",
            type: "POST",
            ...
            success: function (res) {
                ...
                let msg = res.success
                    ? `<b>Permohonan Anda diterima dengan Nomor:</b> ${res.ppa_number}`
                    : res.msg;
